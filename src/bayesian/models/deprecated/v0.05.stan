// v0.05: Offset model that lets the housing-from-tents offset vary by municipality, adding local flexibility beyond v0.04.
data {
...
transformed parameters {
  ...
  mun_phi_housing_offset = sigma_mun_phi_housing_offset
                           * z_mun_phi_housing_offset;
